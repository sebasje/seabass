...
// Five 40-character segments under `root`, created one level at a time
// the way a real library grows. Returns the deepest directory.
...
int main()
{
    // ---- removeTreeDeepestFirst finishes where remove_all cannot ----
    {
        ...
        // 5 directories + the root + the file.
        assert(removed == 7);
