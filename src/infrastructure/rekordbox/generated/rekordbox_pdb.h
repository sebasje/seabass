...
public:
    ...
    static bool _is_defined_page_type_t(page_type_t v);

private:
    static const std::set<page_type_t> _values_page_type_t;

public:

    enum page_type_ext_t {
        PAGE_TYPE_EXT_UNKNOWN_0 = 0,
        PAGE_TYPE_EXT_UNKNOWN_1 = 1,
        PAGE_TYPE_EXT_UNKNOWN_2 = 2,
        PAGE_TYPE_EXT_TAGS = 3,
        PAGE_TYPE_EXT_TAG_TRACKS = 4,
        PAGE_TYPE_EXT_UNKNOWN_5 = 5,
        PAGE_TYPE_EXT_UNKNOWN_6 = 6,
        PAGE_TYPE_EXT_UNKNOWN_7 = 7,
        PAGE_TYPE_EXT_UNKNOWN_8 = 8
    };
    static bool _is_defined_page_type_ext_t(page_type_ext_t v);

private:
    static const std::set<page_type_ext_t> _values_page_type_ext_t;

public:

    rekordbox_pdb_t(bool p_is_ext, kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, rekordbox_pdb_t* p__root = nullptr);
...
public:
    ...
    private:
        page_type_ext_t m_type_ext;
        bool n_type_ext;

    public:
        bool _is_null_type_ext() { type_ext(); return n_type_ext; };

    private:
        std::unique_ptr<page_ref_t> m_next_page;
        uint32_t m_sequence;
        std::string m__unnamed6;
        uint64_t m_num_row_offsets;
        uint64_t m_num_rows;
        uint8_t m_page_flags;
        uint16_t m_free_size;
        uint16_t m_used_size;
        uint16_t m_transaction_row_count;
        uint16_t m_transaction_row_index;
    ...
    public:
         ...
         */
        page_type_ext_t type_ext() const { return m_type_ext; }
         ...
         */
        uint64_t num_row_offsets() const { return m_num_row_offsets; }
         ...
         */
        uint16_t transaction_row_count() const { return m_transaction_row_count; }

        /**
         * The index of the first row touched in the last transaction on this page,
         * or 0x1fff if the last transaction failed.
         */
        uint16_t transaction_row_index() const { return m_transaction_row_index; }
    ...
    private:
        bool f_transaction_row_flags;
        uint16_t m_transaction_row_flags;
    ...
    public:
         ...
         */
        uint16_t transaction_row_flags();
    ...
    private:
        bool f_body_ext;
        std::unique_ptr<kaitai::kstruct> m_body_ext;
        bool n_body_ext;

    public:
        bool _is_null_body_ext() { body_ext(); return n_body_ext; };
    ...
    class tag_row_t : public kaitai::kstruct {

    public:

        tag_row_t(kaitai::kstream* p__io, rekordbox_pdb_t::row_ref_t* p__parent = nullptr, rekordbox_pdb_t* p__root = nullptr);
    ...
    private:
        uint16_t m_subtype;
        uint16_t m_tag_index;
        uint64_t m__unnamed2;
        uint32_t m_category;
        uint32_t m_category_pos;
        uint32_t m_id;
        uint32_t m_raw_is_category;
        uint8_t m__unnamed7;
        uint8_t m_ofs_name_near;
        uint8_t m_ofs_unknown_near;
        rekordbox_pdb_t* m__root;
        rekordbox_pdb_t::row_ref_t* m__parent;
    ...
    public:
         ...
         */
        uint16_t tag_index() const { return m_tag_index; }
         ...
         */
        uint32_t category() const { return m_category; }
         ...
         */
        uint32_t category_pos() const { return m_category_pos; }
         ...
         */
        uint32_t raw_is_category() const { return m_raw_is_category; }
         ...
         */
        uint8_t ofs_unknown_near() const { return m_ofs_unknown_near; }
        rekordbox_pdb_t* _root() const { return m__root; }
        rekordbox_pdb_t::row_ref_t* _parent() const { return m__parent; }
    };
    ...
    class tag_track_row_t : public kaitai::kstruct {

    public:

        tag_track_row_t(kaitai::kstream* p__io, rekordbox_pdb_t::row_ref_t* p__parent = nullptr, rekordbox_pdb_t* p__root = nullptr);
    ...
    public:
         ...
         */
        uint32_t tag_id() const { return m_tag_id; }

        /**
         * Seems to always be 0x03 0x00 0x00 0x00.
         */
        uint32_t _unnamed3() const { return m__unnamed3; }
        rekordbox_pdb_t* _root() const { return m__root; }
        rekordbox_pdb_t::row_ref_t* _parent() const { return m__parent; }
    };
