...
`src/gui/win/app_icon.ico` is regenerated by `python3 tools/flatten_logo.py`,
which needs Pillow rather than ImageMagick and does not have to run on Windows.
